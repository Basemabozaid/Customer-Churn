...
trans = pickle.load(open(r'D:\Basem\Master\Master semester 2024\Data science\project\CX\last\transformer.pkl', 'rb'))

model = pickle.load(open(r'D:\Basem\Master\Master semester 2024\Data science\project\CX\last\log_reg.pkl', 'rb'))
