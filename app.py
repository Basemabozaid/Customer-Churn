...
trans = pickle.load(open(r'D:\Basem\Master\Master semester 2024\Data science\project\CX\transformer.pkl', 'rb'))
model = pickle.load(open(r'D:\Basem\Master\Master semester 2024\Data science\project\CX\log_reg.pkl', 'rb'))
